...
import bags.UnsortedBag;
import org.junit.jupiter.api.Assertions;
import org.junit.Test;

public class UnsortedBagTests {
    private final UnsortedBag<Integer> bag = new UnsortedBag<>();
    ...
    @Test
    public void addToFullBag() {
        for(int i = 0; i < 50; i++) {
            bag.add(i);
        }
        var result = bag.add(50);
    ...
    @Test
    public void fullBagCheck() {
        for(int i = 0; i < 50; i++) {
            bag.add(i);
        }
        var result = bag.isFull();
        Assertions.assertTrue(result);
    }
    ...
    public void getAllElementsAsString() {
        ...
        Assertions.assertEquals("[3 1 4 5 2]", result);
    }
}
