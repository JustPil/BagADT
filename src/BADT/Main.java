...
public class Main {
    ...
    /**
     * sortedBagMenu The menu of choices for a sorted Bag.
     */
    public static void sortedBagMenu() {
    ...
    /**
     * unsortedBagMenu The menu of choices for an unsorted Bag.
     */
    public static void unsortedBagMenu() {
    ...
    /**
     * linkedBagMenu The menu of choices for a sorted linked list Bag
     */
    public static void linkedBagMenu() {
